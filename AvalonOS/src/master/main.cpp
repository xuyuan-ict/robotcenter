...
#include "hierarchical_allocator_process.hpp"
#include "master/master.hpp"

using namespace avalon::internal;
using namespace avalon::internal::master;
...
int main(int argc, char** argv)
{
  ...
  LOG(INFO) << "Starting Avalon master";

  AllocatorProcess* allocatorProcess = new HierarchicalAllocatorProcess();
  ...
  Try<MasterDetector*> detector = 
    MasterDetector::create("", master->self(), true, flags.quiet);
