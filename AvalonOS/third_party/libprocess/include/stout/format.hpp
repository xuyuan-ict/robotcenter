                        ...
                        const T16& t16)
{
  return internal::format(
      ...
      internal::stringify<T13, !std::tr1::is_pod<T13>::value>(t13).get(),
      internal::stringify<T14, !std::tr1::is_pod<T14>::value>(t14).get(),
      internal::stringify<T15, !std::tr1::is_pod<T15>::value>(t15).get(),
      internal::stringify<T16, !std::tr1::is_pod<T16>::value>(t16).get());
}
